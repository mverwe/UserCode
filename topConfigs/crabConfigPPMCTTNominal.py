...
config.General.requestName = 'MCTTNominal_v2'
...
config.Data.inputDataset = '/TT_TuneCUETP8M1_5020GeV-powheg-pythia8/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3-v1/AODSIM'
