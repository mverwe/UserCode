...
config.General.requestName = 'MCWWTo2L2Nu_v2'
...
config.Data.inputDataset = '/WWTo2L2Nu_TuneCUETP8M1_5020GeV-powheg/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3-v1/AODSIM'
